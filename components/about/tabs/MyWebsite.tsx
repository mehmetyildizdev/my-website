...
import { SiVercel, SiShadcnui, SiTailwindcss, SiSanity, SiGoogleanalytics, SiThemoviedatabase } from 'react-icons/si';
    ...
    <section className="flex flex-col xl:flex-row bg-background/50">
      ...
      <div className="xl:w-3/5 2xl:w-4/5 p-8 md:p-12 flex flex-col">
        ...
        <div className="space-y-4 text-foreground/80 leading-relaxed text-sm md:text-base lg:text-lg">
          ...
          <p>
            As a passionate RPG enjoyer, this connection brought extra joy, as these exact &quot;materials&quot; often form the core
            elements of gaming worlds. While exploring color palettes in Adobe, I asked myself:{' '}
            <em>&quot;Why not build a design system based on these materials?&quot;</em>
          </p>
          <p>
            Then, I noticed how Tailwind CSS handles color transformations mathematically on the client. Diving deeper into modern color
            theory, I migrated the entire system to the <strong>OKLCH color space</strong>. The result is a palette where every hue feels
            perceptually balanced and deeply integrated into the theme, covering the full spectrum of the color wheel while maintaining
            visual harmony.
          </p>
          ...
          <p>
            The technical architecture of this site went through its own evolution. Today, the site runs on <strong>Next.js</strong>, which
            provides the agility and seamless integration capabilities I need. I pair it with <strong>Tailwind CSS</strong> and{' '}
            <strong>shadcn/ui</strong>. Adapting my custom OKLCH theme variables to the shadcn schema has been a game-changer, especially
            for allowing AI agents to modify and write components with strict consistency.
          </p>
          <p>
            Instead of building a rigid internal content management system, I opted for <strong>Sanity CMS</strong>, a headless platform.
            Utilizing a decoupled, professional CMS allows me to practice delivering intuitive, secure, and time-efficient editing
          ...
          <p>
            Knowledge is a universal commodity that gains value only when it is shared. I try my best to lean toward{' '}
            <strong>open-source</strong> technologies because I believe the &quot;Great Work&quot; of digital progress is a collaborative
            effort. By building on these platforms, I am standing on the shoulders of giants, aiming to contribute back to that collective
            wisdom.
          </p>
          <p>
            Currently, I am working on a personal <strong>Unification Project</strong> to aggregate my various media hobbies into a
            centralized, custom database-leveraging <strong>TMDB</strong> and my own structured data. My goal is to build environments that
            are sustainable, performant, and accessible, where the complexity of the machine remains hidden, leaving the user with an
            experience as clear as a well-cut gemstone.
          </p>
          ...
          <p>
            I welcome you to explore more in my website. Below are some quick links. Please feel free to connect or reach out if you have
            any questions.
          </p>
      ...
      <div className="xl:w-2/5 2xl:w-1/5 bg-obsidian/10 border-l border-border/20 p-4 flex flex-col space-y-6">
        ...
        <div className="mt-auto pt-6 border-t border-border/10">
          <p className="text-[9px] text-foreground/30 leading-snug text-center italic">Forged in OKLCH</p>
        </div>
      </div>
    </section>
  );
