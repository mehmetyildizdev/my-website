    ...
    <section className="h-full p-8 md:p-12 flex flex-col items-center justify-center space-y-12 overflow-hidden">
      <div className="text-center space-y-6 max-w-2xl">
        ...
        <p className="text-lg text-foreground/70 leading-relaxed">
          Whether you have a specific project in mind, a technical challenge to solve, or just want to exchange ideas about digital architecture. I&apos;m always excited to connect with fellow creators and innovators.
        </p>
      </div>
            ...
            <div className="p-8 md:p-12 space-y-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="modal-name" className="block text-xs font-bold uppercase tracking-wider text-foreground/40 mb-1 ml-1">Name</label>
                    <input
                      type="text"
                      id="modal-name"
                      name="name"
                  ...
                  <div>
                    <label htmlFor="modal-email" className="block text-xs font-bold uppercase tracking-wider text-foreground/40 mb-1 ml-1">Email</label>
                    <input
                      type="email"
                      id="modal-email"
                      name="email"
                ...
                <div>
                  <label htmlFor="modal-message" className="block text-xs font-bold uppercase tracking-wider text-foreground/40 mb-1 ml-1">Message</label>
                  <textarea
                    id="modal-message"
                    name="message"
                ...
                {status.message && (
                  <div className={`p-4 rounded-xl text-sm font-semibold text-center border ${status.type === "success" ? "bg-emerald/10 text-emerald border-emerald/20" : "bg-ruby/10 text-ruby border-ruby/20"
                    }`}>
                    {status.message}
                  </div>
                )}
