    ...
    <Card className="bg-pearl/30 border-border/15 shadow-2xl backdrop-blur-md">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Crew members from different departments who frequently work together across your watched
          films.
        </p>
      </CardHeader>
                ...
                content={
                  <div className="flex flex-col gap-0.5 min-w-[220px] max-w-[300px]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] text-amethyst bg-amethyst/10 px-1.5 py-0.5 rounded">
                        {pair.category_a}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] text-sapphire bg-sapphire/10 px-1.5 py-0.5 rounded">
                        {pair.category_b}
                      </span>
                    </div>
