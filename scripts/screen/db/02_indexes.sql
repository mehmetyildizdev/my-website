...
CREATE INDEX IF NOT EXISTS idx_movies_my_rating ON movies(my_rating DESC);
...
CREATE INDEX IF NOT EXISTS idx_shows_my_rating ON shows(my_rating DESC);
...
CREATE INDEX IF NOT EXISTS idx_watch_history_my_rating ON watch_history(my_rating DESC);
