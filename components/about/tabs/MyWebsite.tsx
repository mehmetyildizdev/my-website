    ...
    <section className="flex flex-col xl:flex-row bg-background/50">
      ...
      <div className="xl:w-3/5 2xl:w-4/5 p-8 md:p-12 flex flex-col">
        ...
        <div className="space-y-4 text-foreground/80 leading-relaxed text-sm md:text-base lg:text-lg">
          ...
          <p>
            I read many classical books in my childhood, but <em>The Alchemist</em> was one of the
            few that truly stuck with me—so much so that chemistry and geometry became my favorite
            subjects leading up to university. As a history of sciences enthusiast, I&apos;ve always
            fascinated by the roles that minerals, metals, and gems play across different
            disciplines.
          </p>
          <p>
            As a passionate RPG enjoyer, this connection brought extra joy, as these exact
            &quot;materials&quot; often form the core elements of gaming worlds. While exploring
            color palettes in Adobe, I asked myself:{' '}
            <em>&quot;Why not build a design system based on these materials?&quot;</em>
          </p>
          <p>
            Then, I noticed how Tailwind CSS handles color transformations mathematically on the
            client. Diving deeper into modern color theory, I migrated the entire system to the{' '}
            <strong>OKLCH color space</strong>. The result is a palette where every hue feels
            perceptually balanced and deeply integrated into the theme, covering the full spectrum
            of the color wheel while maintaining visual harmony.
          </p>
          ...
          <p>
            The technical architecture of this site went through its own evolution. Today, the site
            runs on <strong>Next.js</strong>, which provides the agility and seamless integration
            capabilities I need. I pair it with <strong>Tailwind CSS</strong> and{' '}
            <strong>shadcn/ui</strong>. Adapting my custom OKLCH theme variables to the shadcn
            schema has been a game-changer, especially for allowing AI agents to modify and write
            components with strict consistency.
          </p>
          <p>
            Instead of building a rigid internal content management system, I opted for{' '}
            <strong>Sanity CMS</strong>, a headless platform. Utilizing a decoupled, professional
            CMS allows me to practice delivering intuitive, secure, and time-efficient editing
            experiences—keeping the core code safe from accidental &quot;fiddling.&quot;
          </p>
          ...
          <p>
            Knowledge is a universal commodity that gains value only when it is shared. I try my
            best to lean toward <strong>open-source</strong> technologies because I believe the
            &quot;Great Work&quot; of digital progress is a collaborative effort. By building on
            these platforms, I am standing on the shoulders of giants, aiming to contribute back to
            that collective wisdom.
          </p>
          <p>
            Currently, I am working on a personal <strong>Unification Project</strong> to aggregate
            my various media hobbies into a centralized, custom database-leveraging{' '}
            <strong>TMDB</strong> and my own structured data. My goal is to build environments that
            are sustainable, performant, and accessible, where the complexity of the machine remains
            hidden, leaving the user with an experience as clear as a well-cut gemstone.
          </p>
          ...
          <p>
            I welcome you to explore more in my website. Below are some quick links. Please feel
            free to connect or reach out if you have any questions.
          </p>
        ...
        <div className="flex flex-wrap items-center gap-6 pt-12">
          <div className="flex flex-col items-center group">
            ...
            <span className="text-[10px] uppercase mt-1 opacity-0 group-hover:opacity-100 transition-opacity">
              Vercel
            </span>
          </div>
          <div className="flex flex-col items-center group">
      ...
      <div className="xl:w-2/5 2xl:w-1/5 bg-obsidian/10 border-l border-border/20 p-4 flex flex-col space-y-6">
        <div>
          <h4 className="text-xs font-bold uppercase tracking-[0.2em] light:text-gold text-gold/60 mb-2">
            Elemental Palette
          </h4>
              ...
              {group.elements.map((element) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className={cn('text-[9px] tracking-tighter', group.textColor)}>
                      {element.desc}
                    </span>
                  </div>
                </div>
