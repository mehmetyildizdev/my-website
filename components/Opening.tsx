...
const Opening: React.FC<OpeningProps> = ({ id }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[-10%] left-[-10%] h-[600px] w-[600px] rounded-full bg-ruby/4 blur-[160px] dark:bg-ruby/3" />
      <div className="absolute top-[-10%] right-[-10%] h-[600px] w-[600px] rounded-full bg-topaz/4 blur-[160px] dark:bg-topaz/3" />
      <div className="absolute bottom-[-10%] right-[-10%] h-[600px] w-[600px] rounded-full bg-emerald/4 blur-[160px] dark:bg-emerald/3" />
      <div className="absolute bottom-[-10%] left-[-10%] h-[600px] w-[600px] rounded-full bg-sapphire/4 blur-[160px] dark:bg-sapphire/3" />
      <div className="absolute top-1/2 left-1/2 h-[800px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-amethyst/4 blur-[200px] dark:bg-amethyst/3" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center sm:px-12 lg:px-16">
        ...
        <div className="mx-auto mt-10 max-w-4xl animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300 fill-mode-both text-center">
          <p className="text-lg leading-relaxed text-foreground/70 sm:text-xl italic mb-4">
            a digital sanctuary where <span className="font-bold">systematic logic</span> meets
            the <span className="font-bold">alchemy of modular design</span>
          </p>
